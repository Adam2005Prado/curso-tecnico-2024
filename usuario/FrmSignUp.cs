...
namespace Minha_Parte_Biblio
{
    public partial class FrmSignUp : Form
    {
        ...
        ClConectection conect = new ClConectection();
        ...
        private void FrmSignUp_Load(object sender, EventArgs e)
        {
            ...
            CbCargo.DataSource = conect.obterdados("select * from Table_Cargo");
            CbCargo.DisplayMember = "Cargo";
            CbCargo.ValueMember = "CD_Cargo";
            CbCargo.Text = String.Empty;

            CbAno.DataSource = conect.obterdados("select * from Table_Ano_Escolar");
